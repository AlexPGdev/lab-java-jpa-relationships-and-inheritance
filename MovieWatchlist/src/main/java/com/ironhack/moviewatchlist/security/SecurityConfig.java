package com.ironhack.moviewatchlist.security;

import com.ironhack.moviewatchlist.repository.UserRepository;
import com.ironhack.moviewatchlist.security.filters.CustomAuthenticationFilter;
import com.ironhack.moviewatchlist.security.filters.CustomAuthorizationFilter;
import com.ironhack.moviewatchlist.security.filters.CustomRememberMeFilter;
...
public class SecurityConfig {
    ...
    public SecurityConfig(UserDetailsService userDetailsService, AuthenticationManagerBuilder authManagerBuilder) {
...
//                        .requestMatchers(POST, "/api/movies").hasAnyAuthority("ROLE_USER")
//                        .requestMatchers(DELETE, "/api/movies").hasAnyAuthority("ROLE_USER")
//                        .requestMatchers(PUT, "/api/movies").hasAnyAuthority("ROLE_USER")
//                        .requestMatchers(PATCH, "/api/movies").hasAnyAuthority("ROLE_USER")
//
...
//    }
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, UserRepository userRepository) throws Exception {
        ...
        // Create custom login filter
        CustomAuthenticationFilter customAuthenticationFilter =
                new CustomAuthenticationFilter(authManagerBuilder.getOrBuild(), userRepository);
        customAuthenticationFilter.setFilterProcessesUrl("/api/login");
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/page/user").denyAll()
                        .requestMatchers("/api/page/user/**").denyAll()
        ...
        // Register filters
        http.addFilter(customAuthenticationFilter);
        http.addFilterBefore(new CustomRememberMeFilter(userRepository), UsernamePasswordAuthenticationFilter.class);
        http.addFilterBefore(new CustomAuthorizationFilter(), UsernamePasswordAuthenticationFilter.class);
